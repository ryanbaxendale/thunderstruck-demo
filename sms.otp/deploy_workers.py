...
# sns creds
sns_aws_access_key_id = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
sns_aws_secret_access_key = 'xxxxxxxxxxxxxxxxxxxxxxxxx'
sns_topic_name = 'smsotp'
# aws regions
...
lambda_aws_access_key = "xxxxxxxxxxxxxxxxxxxxxxxxx"
lambda_aws_secret_key = "xxxxxxxxxxxxxxxxxxxxxxxxx"
lambda_function_name = "smsotp"
lambda_function_handler = "worker.lambda_handler"
lambda_function_role = "arn:aws:iam::xxxxxxxxxxxxx:role/lambda_basic_execution"
lambda_zipfile = "lambda_upload.zip"
lambda_s3bucket_name = "thunderstruck-smsotp" # must be a valid s3 bucket name (no _ etc)
...
def deploy_workers(lambda_regions=regions_with_function):
    # the following can be used to get a list of all aws regions that support lambda
...
# uncomment below for each stage

# first setup s3 buckets to upload the worker.zip file
#setup_s3_buckets()

# create the aws lambda function and upload the code
#deploy_workers(lambda_regions=['ap-southeast-1'])
deploy_workers()
